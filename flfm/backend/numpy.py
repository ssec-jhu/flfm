...
def rl_step(
    data: ArrayLike,  # [k, n, n]
    image: ArrayLike,  # [1, n, n]
    PSF_fft: ArrayLike,  # [k, n, n/2+1]
    PSFt_fft: ArrayLike,  # [k, n, n/2+1]
) -> ArrayLike:
    ...
    return data * np.fft.fftshift(np.fft.irfft2(np.fft.rfft2(img_err) * PSFt_fft), axes=(-2, -1))  # [k, n, n]
...
class NumpyRestoration(BaseRestoration):
    ...
    def rfft2(a: ArrayLike, *args, axis: Sequence[int] = (-2, -1), **kwargs):
        ...
        return import_numpy().fft.rfft2(a, *args, axes=axis, **kwargs)

    @staticmethod
    def ones_like(a: ArrayLike, *args, **kwargs) -> ArrayLike:
        """Return an array of ones with the same shape and type as a given array."""
        return import_numpy().ones_like(a, *args, **kwargs)
    ...
    def flip(a: ArrayLike, *args, axis: Sequence[int] = None, **kwargs) -> ArrayLike:
        ...
        return import_numpy().flip(a, *args, axis=axis, **kwargs)

    @staticmethod
    def sum(a: ArrayLike, *args, axis: Sequence[int] = (1, 2), keepdims: bool = True, **kwargs):
        """Sum of array elements over a given axis."""
        return import_numpy().sum(a, axis=axis, keepdims=keepdims)
